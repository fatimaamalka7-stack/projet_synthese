    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'description' => 'Robe élégante et confortable pour un style moderne et intemporel.',
                'price' => 399.00,
                'stock' => 35,
                'matiere' => 'Polyester et viscose',
                'tailles' => 'XS,S,M,L,XL',
                'couleurs' => 'Noir,Bleu marine,Rouge',
                'image' => 'https://placehold.co/600x800/fce7f3/9d174d?text=Robe+Elegante',
            ],
            [
                'name' => 'T-shirt Femme Fashion',
                'slug' => 't-shirt-femme-fashion',
                'description' => 'T-shirt femme tendance avec coupe flatteuse et confortable.',
                'price' => 149.00,
                'stock' => 60,
                'matiere' => '100% coton premium',
                'tailles' => 'XS,S,M,L,XL,XXL',
                'couleurs' => 'Blanc,Noir,Rose poudre,Kaki',
                'image' => 'https://placehold.co/600x800/fce7f3/ec4899?text=T-shirt+Femme',
            ],
            [
                'name' => 'Pantalon Femme Slim',
                'slug' => 'pantalon-femme-slim',
                'description' => 'Pantalon slim femme avec coupe ajustée et confortable.',
                'price' => 349.00,
                'stock' => 45,
                'matiere' => '95% coton, 5% elasthanne',
                'tailles' => '34,36,38,40,42,44,46',
                'couleurs' => 'Noir,Bleu indigo,Gris anthracite',
                'image' => 'https://placehold.co/600x800/dbeafe/1e40af?text=Pantalon+Slim',
            ],
            [
                'name' => 'Abaya Moderne',
                'slug' => 'abaya-moderne',
                'description' => 'Abaya moderne et élégante, confortable pour un port quotidien.',
                'price' => 499.00,
                'stock' => 40,
                'matiere' => 'Tissu fluide premium',
                'tailles' => 'S,M,L,XL,XXL',
                'couleurs' => 'Noir,Bleu marine,Marron',
                'image' => 'https://placehold.co/600x800/1f2937/f3f4f6?text=Abaya+Moderne',
            ],
            [
                'name' => 'Ensemble Femme Chic',
                'slug' => 'ensemble-femme-chic',
                'description' => 'Ensemble femme chic avec blazer et pantalon assortis.',
                'price' => 699.00,
                'stock' => 28,
                'matiere' => 'Tissu mélangé polyester',
                'tailles' => 'S,M,L,XL',
                'couleurs' => 'Noir,Gris clair,Taupe',
                'image' => 'https://placehold.co/600x800/e0e7ff/4c1d95?text=Ensemble+Chic',
            ],
        ];
